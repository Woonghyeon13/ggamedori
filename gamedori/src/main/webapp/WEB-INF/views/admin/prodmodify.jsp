		...
		<div class="container w-75">
			...
			<form name="prodModify" method="post" action="prodmodify.do"
				...
				<table id="optTable" class="d-grid gap-1 mt-2 table form-group">
						<c:forEach var="optt" items="${optlist}">
							<tr>
								<td class='form-group mt-1 d-flex input-group justify-content-between align-items-center'>
								<span class='input-group-text' id='basic-addon1'>옵션명</span>
								<input value="${optt.opt_name}" type='text' class='form-control' name='opt_name'>
								<span class='input-group-text' id='basic-addon1'>재고</span>
								<input value="${optt.opt_stock}" type='text' class='form-control' name='opt_stock'>
								<span class='input-group-text' id='basic-addon1'>가격</span>
								<input value="${optt.opt_price}" type='text' class='form-control' name='opt_price'>
								</td>
							</tr>
						</c:forEach>
				</table>
